...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Nirali Gupta — Full Stack Python Developer specializing in Django, FastAPI, React and data visualization." },
      { name: "author", content: "Nirali Gupta" },
      { property: "og:title", content: "Nirali Gupta — Full Stack Python Developer" },
      { property: "og:description", content: "Django, FastAPI, React, Next.js — building scalable APIs and data visualization platforms." },
